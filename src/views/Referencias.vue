...
.curso-main-container.referencias
  BannerInterno.text-uppercase(icono="fas fa-book" subTitulo="Referencias bibliográficas" titulo="Unidad 2. Desarrollo físico, cognitivo y emocional en las etapas de la infancia y adolescencia")
