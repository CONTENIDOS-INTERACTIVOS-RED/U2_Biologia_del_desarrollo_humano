...
.curso-main-container.glosario
  BannerInterno(icono="fas fa-atlas" subTitulo="GLOSARIO" titulo="Unidad 2. Desarrollo físico, cognitivo y emocional en las etapas de la infancia y adolescencia")
